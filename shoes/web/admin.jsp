<%-- 
    Document   : admin
    Created on : 13 Apr, 2017, 2:54:34 PM
    Author     : Aditya
--%>
...
<!--             <span class="pull-right-container">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/add product.html"><i class="fa fa-circle-o"></i> Add Product</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/tables/order details.html"><i class="fa fa-circle-o"></i> Order Details</a></li>
            <li><a href="pages/tables/product details.html"><i class="fa fa-circle-o"></i> Product Details</a></li>
			<li><a href="pages/tables/vendor details.html"><i class="fa fa-circle-o"></i> Vendor Details</a></li>
          </ul>
        </li>
